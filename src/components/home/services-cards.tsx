...
export default function ServicesCards({ triggerRef }: ServicesCardsProps) {
    ...
    useGSAP(() => {
        ...
        mm.add("(min-width: 769px)", () => {
            // 1. POSITION FIXING (Keeps cards visible during scroll)
            ScrollTrigger.create({
                trigger: triggerRef.current,
                start: "top top",
                end: `+=${window.innerHeight * 4}px`,
                onLeave: () => {
                    const servicesSection = triggerRef.current;
                ...
                onUpdate: (self) => {
                    ...
                    if (cardElements) {
                        cardElements.forEach((card, index) => {
                            ...
                            // FORCE OPACITY FOR DEBUGGING/VISIBILITY IF NEEDED
                            // opacity = 1; 
    ...
    }, { scope: container, dependencies: [triggerRef] });

    return (
        <section className={styles.cards} ref={container}>
                ...
                {CARDS.map((card, index) => (
                    <div
                        ...
                        style={{
                            ...
                            zIndex: index // Ensure lower index cards are below (or above? Usually 0 is bottom. Let's stack sequentially.)
                        }}
                    >
